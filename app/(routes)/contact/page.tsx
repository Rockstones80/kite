...
export default function ContactPage() {
  ...
  return (
    <>
      ...
      <section className="relative h-[62vh] w-full pt-20">
        {/* Background Image */}
      ...
      {/* Contact Channels Section - White Background */}
      <section
        ref={ref}
        className="relative w-full bg-white py-16 sm:py-20 md:py-32 px-4 sm:px-6 lg:px-12"
      >
                ...
                <div className="flex-1 space-y-4">
                  ...
                  <div className="space-y-2">
                    <a
                      ...
                      className="block text-base sm:text-lg text-gray-900 hover:text-red-600 transition-colors"
                    >
